...
?>
    ...
    <section class="ftco-section" style="position: -webkit-sticky;position: sticky;top: 0;margin: 30px 125px 300px 125px;
            ...
            <div class="row">
                <div class="col-md-12">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="cartitems-tab" data-toggle="tab" href="#cartitems" role="tab" aria-controls="cartitems" aria-selected="false">Cart <span id="cart-count-no" style="color: #fff;background-color: #a900ff;display: inline-block;padding: 5px;font-size: 12px;line-height: 1;text-align: center;white-space: nowrap;vertical-align: baseline;border-radius: 5px;font-family: 'Montserrat', Arial, sans-serif;"><?php echo $CartCount; ?></span></a>
                        </li>
                    </ul>
                                        ...
                                        <div class="list-group" id="Orderlist-tab" role="tablist" style="overflow-y: scroll;height: 500px;">
                                            <?php
                                                ...
                                                foreach ($StoreCategories as $value) {
                                                    if($ActiveCount == 1){
                                                        echo '<a class="list-group-item list-group-item-action active" id="list-home-list" data-type="store" data-category="'.$value["id"].'" data-store="'.$value["store"].'" data-toggle="list" href="#list-StoreServices" role="tab" aria-controls="home">
                                                        ...
                                                        echo '<a class="list-group-item list-group-item-action" id="list-home-list" data-type="store" data-category="'.$value["id"].'" data-store="'.$value["store"].'"    data-toggle="list" href="#list-StoreServices" role="tab" aria-controls="home">
                                                        <div class="image-parent" style="display: inline-block;margin-right: 20px;">
                                                            <img src="'.$value["image"].'" style="height: 50px;width: 50px;border-radius: 50%;" alt="quixote">
                                                        </div>
                                                        '.$value["name"].'</a>';
                                        ...
                                        <div class="list-group" id="Homelist-tab" role="tablist" style="overflow-y: scroll;height: 500px;">
                                            <?php
                                                ...
                                                foreach ($HomeCategories as $value) {
                                                    if($ActiveCount == 1){
                                                        echo '<a class="list-group-item list-group-item-action active" id="list-home-list" data-type="home" data-category="'.$value["id"].'" data-store="'.$value["store"].'" data-toggle="list" href="#list-HomeServices" role="tab" aria-controls="home">
                                                        <div class="image-parent" style="display: inline-block;margin-right: 20px;">
                                                            <img src="'.$value["image"].'" style="height: 50px;width: 50px;border-radius: 50%;" alt="quixote">
                                                        </div>
                                                        '.$value["name"].'</a>';
                                                        ...
                                                        echo '<a class="list-group-item list-group-item-action" id="list-home-list" data-type="home" data-category="'.$value["id"].'" data-store="'.$value["store"].'"    data-toggle="list" href="#list-HomeServices" role="tab" aria-controls="home">
                                                        <div class="image-parent" style="display: inline-block;margin-right: 20px;">
                                                            <img src="'.$value["image"].'" style="height: 50px;width: 50px;border-radius: 50%;" alt="quixote">
                                                        </div>
                                                        '.$value["name"].'</a>';
    ...
    <script type="text/javascript">
        ...
        function pay_now()
        {
            var name          = "<?php echo $Profile["first_name"] . " " . $Profile["last_name"]; ?>";
