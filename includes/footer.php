    ...
    <footer class="ftco-footer ftco-section img" style="padding:100px;">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p>
                Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | <a href="<?php echo SITE_URL; ?>" target="_blank">Saloon Pro</a>
            </p>
          </div>
        </div>
      </div>
